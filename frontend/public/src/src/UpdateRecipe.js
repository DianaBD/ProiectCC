...
import { Button, Icon, Form, Table, Dropdown } from 'semantic-ui-react'
...
function UpdateRecipe(props) {
    const [recipe, setUserData] = useState({})
    ...
    if (!requested) {
        ...
        axios.get(`http://localhost/recipes/${id}`, {
            headers: {
    ...
    function handleSubmit(e) {
        ...
        if(checkFormCompleted(payload)){
          ...
          axios.put(`http://localhost/recipes/${id}` , payload, {
              headers: {
                  Authorization: `Bearer ${token}`
              }
          })
        ...
        <div id='mainContainer'>
          ...
          <Form>
                  ...
                  <Table definition>
                    <Table.Header>
                      <Table.Row>
                        <Table.HeaderCell colSpan='3' style={{ fontSize: '1.2rem', paddingLeft: '2rem' }}>Recipe information</Table.HeaderCell>
                        <Table.HeaderCell colSpan='1' style={{ fontSize: '1.2rem', paddingLeft: '2rem' }}>Update recipe information</Table.HeaderCell>
                      </Table.Row>
                    </Table.Header>
                    ...
                    <Table.Body>
                      ...
                      <Table.Row>
                        ...
                        <Table.Cell>
                          <Button className='fillBtn grow' circular size='tiny' style={{float: 'right', marginTop: '-1rem', marginBottom: '-1rem'}} inverted onClick={() => autoCompleteField('name', recipe.name)}>
                            <Icon name='arrow circle right'  color='teal' size='large' > </Icon>
                          </Button>
                        </Table.Cell>
                      ...
                      <Table.Row>
                        ...
                        <Table.Cell>{recipe.goals}</Table.Cell>
                      ...
                      <Table.Row>
                        ...
                        <Table.Cell>{recipe.hairType}</Table.Cell>
                          <Table.Cell>  </Table.Cell>
                      ...
                      <Table.Row>
                        ...
                        <Table.Cell>{recipe.hairStructure}</Table.Cell>
                          <Table.Cell>  </Table.Cell>
                      ...
                      <Table.Row>
                        ...
                        <Table.Cell>{recipe.scalpMoisture}</Table.Cell>
                          <Table.Cell>  </Table.Cell>
                      ...
                      <Table.Row>
                        ...
                        <Table.Cell>{recipe.siliconFree}</Table.Cell>
                        <Table.Cell>
                          <Button className='fillBtn grow' circular size='tiny' style={{float: 'right', marginTop: '-1rem', marginBottom: '-1rem'}} inverted onClick={() => autoCompleteField('siliconFree', recipe.siliconFree)}>
                          <Icon name='arrow circle right'  color='teal' size='large' > </Icon></Button>
                        </Table.Cell>
                      ...
                      <Table.Row>
                        ...
                        <Table.Cell>{recipe.fragrance}</Table.Cell>
                        <Table.Cell>  </Table.Cell>
                      ...
                      <Table.Row>
                        ...
                        <Table.Cell>{recipe.shampooColor}</Table.Cell>
                        <Table.Cell>  </Table.Cell>
                      ...
                      <Table.Row>
                        ...
                        <Table.Cell>
                          <Form.Field>
                          <Dropdown  placeholder='Size - choose one'  fluid search selection  options={sizeOptions}  onChange={updateField}  id='size'  name='size'  /></Form.Field>
                        </Table.Cell>
                      </Table.Row>

                      <Table.Row>
                        <Table.Cell>Frequency</Table.Cell>
                        <Table.Cell>{recipe.frequency}</Table.Cell>
                        <Table.Cell>  </Table.Cell>
                      ...
                      <Table.Row>
                        ...
                        <Table.Cell>{recipe.subscription}</Table.Cell>
                        <Table.Cell>
                          <Button className='fillBtn grow' circular size='tiny' style={{float: 'right', marginTop: '-1rem', marginBottom: '-1rem'}} inverted onClick={() => autoCompleteField('subscription', recipe.subscription)}>
                          <Icon name='arrow circle right'  color='teal' size='large' > </Icon></Button>
                        </Table.Cell>
                  ...
                  <Button renderAs='button' color='teal' size='large' onClick={handleSubmit}> Update recipe </Button>
